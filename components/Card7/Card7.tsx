...
const Card7: FC<Card7Props> = ({
  ...
  return (
    <div
      className={`nc-Card7 relative flex flex-col group rounded-lg overflow-hidden z-0 ${hoverClass} ${className}`}
    >
      ...
      <div className="absolute bottom-3 inset-x-3 p-4 bg-white dark:bg-neutral-900 flex flex-col flex-grow rounded-lg group-hover:shadow-2xl transition-shadow">
