...
const SectionVideos: FC<SectionVideosProps> = ({
  ...
  const renderMainVideo = () => {
    ...
    return (
      <div
        className="group aspect-w-16 aspect-h-16 sm:aspect-h-9 bg-neutral-800 rounded-lg overflow-hidden 
  ...
  const renderSubVideo = (video: VideoType, index: number) => {
    ...
    return (
      <div
        className="group relative aspect-h-16 aspect-w-16 rounded-2xl cursor-pointer overflow-hidden sm:aspect-h-12 sm:rounded-lg lg:aspect-h-9 z-0"
        onClick={() => {
  ...
  return (
    <div className={`nc-SectionVideos ${className}`}>
      ...
      <div className="flex flex-col relative sm:pr-4 sm:py-4 md:pr-6 md:py-6 xl:pr-14 xl:py-14 lg:flex-row">
        <div className="absolute -top-4 -bottom-4 -right-4 w-2/3 rounded-lg bg-primary-100/40 z-0 sm:rounded-[50px] md:top-0 md:bottom-0 md:right-0 xl:w-1/2 dark:bg-neutral-800/40"></div>
